       ...
       function sendWsMsg(msg, index = 0) {
        ...
        function updateStatus() {
          ...
          Object.entries(updateData).forEach(([key, value]) => {
            // Bolt Performance Optimization: Replace 4 individual DOM queries with 1 getElementById lookup
            const el = document.getElementById(key);
            if (el) {
              const nodeName = el.nodeName;
              if (nodeName === 'text' || nodeName === 'TEXT') el.textContent = value; // svg button
